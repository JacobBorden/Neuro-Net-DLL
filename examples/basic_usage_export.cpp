...
void test_model_json_io(NeuroNet::NeuroNet& best_model, const std::vector<std::vector<float>>& test_inputs, const std::vector<float>& expected_outputs) {
...
void run_genetic_algorithm_xor_example() {
    ...
    if (best_model.getLayerCount() > 0) {
        ...
        test_model_json_io(best_model, test_inputs, expected_outputs);
