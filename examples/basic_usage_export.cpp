...
void test_model_using_json(NeuroNet::NeuroNet& best_model) {
...
void demonstrate_vocabulary_features(NeuroNet::NeuroNet& best_model) {
...
void run_genetic_algorithm_xor_example() {
    ...
    if (best_model.getLayerCount() > 0) {
        ...
        test_model_using_json(best_model);

        // Demonstrate String Input and Vocabulary Features
        demonstrate_vocabulary_features(best_model);
...
int main() {
    // Run the Genetic Algorithm XOR example
    run_genetic_algorithm_xor_example();
