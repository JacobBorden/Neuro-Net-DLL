...
NeuroNet::NeuroNet run_ga_xor_training() {
...
void test_model_xor(NeuroNet::NeuroNet& best_model) {
...
void test_model_json(NeuroNet::NeuroNet& best_model) {
...
void run_string_input_demo(NeuroNet::NeuroNet best_model) {
...
int main() {
    ...
    NeuroNet::NeuroNet best_model = run_ga_xor_training();

    if (best_model.getLayerCount() > 0) {
        test_model_xor(best_model);
        test_model_json(best_model);
        run_string_input_demo(best_model);
    } else {
