...
void test_best_model_numeric(NeuroNet::NeuroNet& best_model, const std::vector<std::vector<float>>& test_inputs, const std::vector<float>& expected_outputs) {
...
void test_best_model_json(NeuroNet::NeuroNet& best_model, const std::vector<std::vector<float>>& test_inputs, const std::vector<float>& expected_outputs) {
...
int main() {
    ...
    if (best_model.getLayerCount() > 0) {
        ...
        test_best_model_numeric(best_model, test_inputs, expected_outputs);
        test_best_model_json(best_model, test_inputs, expected_outputs);
