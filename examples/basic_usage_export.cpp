...
void test_xor_model_basic(NeuroNet::NeuroNet& best_model, const std::vector<std::vector<float>>& test_inputs, const std::vector<float>& expected_outputs) {
...
void test_xor_model_json(NeuroNet::NeuroNet& best_model, const std::vector<std::vector<float>>& test_inputs, const std::vector<float>& expected_outputs) {
...
void demonstrate_string_input_features(NeuroNet::NeuroNet best_model) {
...
int main() {
    ...
    if (best_model.getLayerCount() > 0) {
        ...
        test_xor_model_basic(best_model, test_inputs, expected_outputs);
        test_xor_model_json(best_model, test_inputs, expected_outputs);
        demonstrate_string_input_features(best_model);
